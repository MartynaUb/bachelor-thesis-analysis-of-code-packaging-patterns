...
\begin{figure}[H]
    ...
    \endsnugshade
    \caption{\textit{azure-storage-blob-cryptograph} kriptografijos klasių struktūra po jų iškelimo į paketus}
    \label{fig:rep2}
\end{figure}
...
Pavyzdyje~\ref{table:sistemos}matomos pertvarkytos sistemos, joses rasto problemos ir šablonų, panaudotų problemų išsprenimui sąrašas.
...
Atlikus sistemų pertvarkymus buvo gauti objektyvus matai įrodantys, jog atrinkti šablonai, prisidėda ne tik prie kodo suprantamumo žmogui, bet taip pat ir daro
teigiamą įtaka sistemos kokybėi - dauguma atveju mažina ciklines priklausomybės, vidutini klasių skaičių pakete, atstumą nuo pagrindinės sekos.