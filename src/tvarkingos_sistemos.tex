...
\subsection{Kompiuterinė sistemos kokybė}
...
\begin{itemize}
    ...
    Šios metrikos diapazonas yra nuo nulio iki vieno, kur nulis reiškia paketą, sutampantį su pagrindine seka, o vienas - paketą, maksimaliai nutolusį nuo pagrindinės sekos.
...
Rezultatai gauti iš šio tyrimo rodo statistiškai reikšmingą koreliaciją tarp daugumos metrikų ir
