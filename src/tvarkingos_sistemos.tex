...
\begin{itemize}
    ...
    \item \textbf{Aferentinės jungtys \angl{Afferent Couplings}} - aferentinių jungčių metrika nurodo
    skaičių paketų, kurie priklauso nuo klasių, esančių pasirinktame pakete.
    Ši metrika matuoja ateinančias priklausomybes.
    \item \textbf{Eferentinės jungtys \angl{Efferent Couplings}} - eferentinių jungčių metrika nurodo skaičių kitų paketų,
    ...
    \item \textbf{Abstrakcija} - paketo abstrakcijos metrika nurodo santykį tarp abstrakčių klasių (arba sąsajų \angl{interface}) pakete ir bendro klasių skaičiaus:
    \begin{equation}
    ...
    Šios metrikos diapazonas yra nuo nulio iki vieno, kur vienas reiškia paketą, sutampantį su pagrindinę seka, o vienas - paketą, maksimaliai nutolusi nuo pagrindinės sekos.
    \item \textbf{Žiedinės priklausomybės} - žiedinių priklausomybių metrika skaičiuoja atvejus,
...
Šių metrikų patikimumas buvo ivertintas atvejo analyzėje \textit{Exploring the Relationships between Design Metrics and Package
Understandability: A Case Study}, kurioje autoriai tyrinėjo sąryši tarp minetų metrikų ir vidutinių pastangų, reikalingų suprasti objektinio dizaino paketą.
Tyrimas atlikta naudojant aštuoniolika paketų, paimtų iš dviejų atvirodo kodo programinės įrangos sistemų.
Paskaičiuoti pastangas, reikalingas paketui suprasti, buvo pasitelktos trys skirtingos komandos, turinčios po trys panašią patirtį turinčius porgramuotojus.
Jų buvo paprašta pilnai suprasti paketų funkcionaluma ir nuo vieno iki dešimt įvertinti pastangas, reikalingas suprastį kiekvieną paketą.
Rezultatai gauti iš šio tyrimo rodo statistiškai reikšmingą koreliacija tarp daugumos metrikų ir
