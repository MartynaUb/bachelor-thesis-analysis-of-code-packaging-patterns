...
\begin{itemize}
    ...
    \item \textit{Abstrakcija} - paketo abstrakcijos metrika nurodo santykį tarp abstrakčių klasių (arba sąsajų \angl{interface}) pakete ir bendro klasių skaičiaus:
    \begin{equation}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[scale=0.2]{img/zones_of_exclusion}
