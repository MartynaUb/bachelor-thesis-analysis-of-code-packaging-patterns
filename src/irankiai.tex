...
aiškiai apibrėžtų programinių įrankių pagalbą.
...
Surinkta informacija naudojama įgyvendinti kiekvienam aprašytam įrankio funkcionalumui, ten, kur galima, naudojant jau parašytus trečiųjų įrankius, taip programiškai supaprastinant
skirtingų įrankių vykdymą.
Gauti atliktos analizės rezultatais rezultatai išvedami į failus nurodytoje direktorijoje.
Rezultatus sudaro apdorotos sistemos paketų kokybės matai, paketų struktūros medis, paketų priklausomybės grafikas.
Gauti rezultatai išvesti \textit{latex} formatu, todėl gali būti lengvai pridedami į darbo dokumentą, taip padarant sistemų analizę daug greitesnę bei efektyvesnę.
