...
(arba posistemėms) nėra patogu - kiekvieną įrankį reikėtų vykdyti atskirai, skirtingais vykdymo procesais ir argumentais. Taip išvestų rezultatų formatai yra skirtingi.
...
apdoroja failus nurodytoje sistemos direktorijoje, nuskaito \textit{java} failų turinį ir išveda informaciją apie sistemos paketus bei klases.
