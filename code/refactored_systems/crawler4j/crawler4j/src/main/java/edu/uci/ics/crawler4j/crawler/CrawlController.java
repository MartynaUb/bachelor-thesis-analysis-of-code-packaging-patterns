...
import edu.uci.ics.crawler4j.robotstxt.permissions.CrawlingPermissions;
...
public class CrawlController {
    ...
    private final UrlCanonicalizer canonicalizer = UrlCanonicalizer.getUrlCanonicalizer();
    ...
    private final UrlCanonicalizer urlCanonicalizer = UrlCanonicalizer.getUrlCanonicalizer();


    protected PageFetcher pageFetcher;
    protected CrawlingPermissions permissions;
    ...
    public CrawlController(CrawlConfig config, PageFetcher pageFetcher,
                           CrawlingPermissions permissions) throws Exception {
        this(config, pageFetcher, null, permissions, null);
    }

    public CrawlController(CrawlConfig config, PageFetcher pageFetcher,
                           CrawlingPermissions permissions, TLDList tldList) throws Exception {
        this(config, pageFetcher, null, permissions, tldList);
    }
    ...
    public CrawlController(CrawlConfig config, PageFetcher pageFetcher, Parser parser,
        ...
        this.tldList = tldList == null ? TLDList.fromFile(config) : tldList;
        canonicalizer.setHaltOnError(config.isHaltOnError());
        ...
        permissions.setCrawlConfig(config);
    }
    ...
    public void addSeed(String pageUrl, int docId) throws IOException, InterruptedException {
        String canonicalUrl = canonicalizer.getCanonicalURL(pageUrl);
    ...
    public CrawlingPermissions getPermissions() {
        return permissions;
    }

    public void setPermissions(CrawlingPermissions permissions) {
        this.permissions = permissions;
    }
