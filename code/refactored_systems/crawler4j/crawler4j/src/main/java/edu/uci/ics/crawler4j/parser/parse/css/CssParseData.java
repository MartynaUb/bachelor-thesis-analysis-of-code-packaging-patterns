...
package edu.uci.ics.crawler4j.parser.parse.css;
...
public class CssParseData implements ParseData {
    ...
    private Set<WebURL> parseOutgoingUrls(WebURL referringPage) throws UnsupportedEncodingException {
        ...
        Set<String> extractedUrls = extractUrlInCssText(this.getContent());
