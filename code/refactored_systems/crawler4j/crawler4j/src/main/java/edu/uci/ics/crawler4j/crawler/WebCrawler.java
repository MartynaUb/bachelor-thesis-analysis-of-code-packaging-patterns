...
import edu.uci.ics.crawler4j.util.PageBiggerThanMaxSizeException;
import edu.uci.ics.crawler4j.fetcher.PageFetchResult;
import edu.uci.ics.crawler4j.fetcher.PageFetcher;
import edu.uci.ics.crawler4j.frontier.DocIDServer;
import edu.uci.ics.crawler4j.frontier.Frontier;
import edu.uci.ics.crawler4j.web.Page;
...
public class WebCrawler implements Runnable {
    ...
    /**
     * The CrawlingPermissions instance that is used by this crawler instance to
     * determine whether the crawler is allowed to crawl the content of each page.
     */
    private CrawlingPermissions permissions;
    ...
    public void init(int id, CrawlController crawlController)
        ...
        this.permissions = crawlController.getPermissions();
     ...
     */
    protected void onRedirectedStatusCode(ParsedPage page) {
     ...
     * @param page
     */
    protected void onRedirectedToInvalidUrl(ParsedPage page) {
     ...
     *
     * @deprecated use {@link #onContentFetchError(ParsedPage)}
     */
    @Deprecated
     ...
     * @param page Partial page object
     */
    protected void onContentFetchError(ParsedPage page) {
     ...
     */
    public boolean shouldVisit(ParsedPage referringPage, WebURL url) {
     ...
     */
    public void visit(ParsedPage page) {
        // Do nothing by default
    ...
    private void processPage(WebURL curURL) throws IOException, InterruptedException, ParseException {
        ...
        ParsedPage page = Page.newPage(curURL);
        try {
            if (curURL == null) {
                return;
            }
                ...
                if (statusCode == HttpStatus.SC_MOVED_PERMANENTLY ||
                    ...
                    if (myController.getConfig().isFollowRedirects()) {
                        ...
                        if (shouldVisit(page, webURL)) {
                            if (!shouldFollowLinksIn(webURL) || permissions.allows(webURL)) {
