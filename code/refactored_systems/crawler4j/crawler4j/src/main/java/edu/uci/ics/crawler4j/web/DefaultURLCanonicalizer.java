 ...
 */
class DefaultURLCanonicalizer implements UrlCanonicalizer {
    ...
    @Override
    public String getCanonicalURL(String url) throws UnsupportedEncodingException {
        return getCanonicalURL(url, null);
    }

    @Override
    public String getCanonicalURL(String href, String context) throws UnsupportedEncodingException {
        return getCanonicalURL(href, context, StandardCharsets.UTF_8);
    }

    @Override
    public String getCanonicalURL(String href, String context, Charset charset) throws UnsupportedEncodingException {
     ...
     */
    private String canonicalize(Map<String, String> paramsMap, Charset charset)
        throws UnsupportedEncodingException {
    ...
    private String percentEncodeRfc3986(String string, Charset charset) throws UnsupportedEncodingException {
        try {
