...
class TikaHtmlParser implements edu.uci.ics.crawler4j.parser.html.HtmlParser {
    ...
    @Override
    public HtmlParseData parse(ParsedPage page, String contextURL) throws ParseException {
        ...
        try {
            ...
            if (page.getContentCharset() == null) {
                parsedData.setContent(new String(page.getContentData()));
            } else {
                parsedData.setContent(new String(page.getContentData(), page.getContentCharset()));
            }
    ...
    private String chooseEncoding(ParsedPage page, Metadata metadata) {
