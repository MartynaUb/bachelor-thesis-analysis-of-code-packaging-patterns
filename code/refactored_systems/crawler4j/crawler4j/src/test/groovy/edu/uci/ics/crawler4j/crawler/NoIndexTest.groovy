...
import edu.uci.ics.crawler4j.robotstxt.permissions.ServerBasedCrawlingPermissions
...
class NoIndexTest extends Specification {
    ...
    def "ignore noindex pages"() {
        ...
        ServerBasedCrawlingPermissions robotstxtServer = new ServerBasedCrawlingPermissions(new RobotstxtConfig(), pageFetcher)
        ...
        Map<String, ParsedPage> visitedPages = (Map<String, ParsedPage>)controller.getCrawlersLocalData().get(0);
...
class NoIndexWebCrawler extends WebCrawler {
	...
	private Map<String, ParsedPage> visitedPages;
	
	public void init(int id, CrawlController crawlController) {
		super.init(id, crawlController);
		visitedPages = new HashMap<String, ParsedPage>();
	}
