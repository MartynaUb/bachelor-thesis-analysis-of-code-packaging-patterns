...
class OnRedirectedToInvalidTest extends Specification {
    ...
    def "intercept redirect to invalid url"() {
        ...
        ServerBasedCrawlingPermissions robotstxtServer = new ServerBasedCrawlingPermissions(robotstxtConfig, pageFetcher)
...
class HandleInvalidRedirectWebCrawler extends WebCrawler {
    ...
    @Override
    void onRedirectedToInvalidUrl(ParsedPage page) {
