...
import edu.uci.ics.crawler4j.url.tld.TLDListFromFile
import spock.lang.*
import edu.uci.ics.crawler4j.crawler.*

class PublicSuffixTest extends Specification {
    
    @Shared internalTldList = new TLDListFromFile(new CrawlConfig(
        onlineTldListUpdate:    false
    ))

    @Shared externalTldList = new TLDListFromFile(new CrawlConfig(
