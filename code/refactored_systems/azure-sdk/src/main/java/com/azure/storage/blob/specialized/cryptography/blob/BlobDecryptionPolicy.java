...
import com.azure.storage.blob.specialized.cryptography.util.CryptographyConstants;
...
import static com.azure.storage.blob.specialized.cryptography.util.CryptographyConstants.CONTENT_LENGTH;
import static com.azure.storage.blob.specialized.cryptography.util.CryptographyConstants.CONTENT_RANGE;
import static com.azure.storage.blob.specialized.cryptography.util.CryptographyConstants.ENCRYPTION_BLOCK_SIZE;
import static com.azure.storage.blob.specialized.cryptography.util.CryptographyConstants.ENCRYPTION_DATA_KEY;
import static com.azure.storage.blob.specialized.cryptography.util.CryptographyConstants.ENCRYPTION_METADATA_HEADER;
import static com.azure.storage.blob.specialized.cryptography.util.CryptographyConstants.ENCRYPTION_PROTOCOL_V1;
import static com.azure.storage.blob.specialized.cryptography.util.CryptographyConstants.RANGE_HEADER;
...
public class BlobDecryptionPolicy implements HttpPipelinePolicy {
    ...
    Flux<ByteBuffer> decryptBlob(Flux<ByteBuffer> encryptedFlux, EncryptedBlobRange encryptedBlobRange, boolean padding,
        ...
        Decryptor decryptor = DecryptorFactory.getDecryptor(keyResolver, keyWrapper, encryptionData);
