...
package com.azure.storage.blob.specialized.cryptography.decryptor.v1;
...
import static com.azure.storage.blob.specialized.cryptography.util.CryptographyConstants.AES_CBC_NO_PADDING;
import static com.azure.storage.blob.specialized.cryptography.util.CryptographyConstants.AES_CBC_PKCS5PADDING;
import static com.azure.storage.blob.specialized.cryptography.util.CryptographyConstants.ENCRYPTION_BLOCK_SIZE;

public class DecryptorV1 extends Decryptor {
    private static final ClientLogger LOGGER = new ClientLogger(DecryptorV1.class);

    public DecryptorV1(AsyncKeyEncryptionKeyResolver keyResolver, AsyncKeyEncryptionKey keyWrapper,
        EncryptionData encryptionData) {
        super(keyResolver, keyWrapper, encryptionData);
    }

    @Override
    public Flux<ByteBuffer> decrypt(Flux<ByteBuffer> encryptedFlux, EncryptedBlobRange encryptedBlobRange,
    ...
    @Override
    public Cipher getCipher(byte[] contentEncryptionKey, byte[] iv, boolean padding)
