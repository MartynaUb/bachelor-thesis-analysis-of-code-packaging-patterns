...
package com.azure.storage.blob.specialized.cryptography.encryptor.v1;
...
import com.azure.storage.blob.specialized.cryptography.encription.data.EncryptionAlgorithm;
...
public class EncryptorV1 extends Encryptor {
     ...
     */
    public EncryptorV1(SecretKey aesKey) throws GeneralSecurityException {
        super(aesKey);
