 ...
 */
public final class WrappedKeyJson {
    ...
    /**
     * Initializes a new instance of the {@link WrappedKeyJson} class.
     */
    WrappedKeyJson() {
    }

    /**
     * Initializes a new instance of the {@link WrappedKeyJson} class using the specified key id, encrypted key and
     * the algorithm.
     *
     ...
     */
    WrappedKeyJson(String keyId, byte[] encryptedKey, String algorithm) {
        this.keyId = keyId;
     ...
     * @return this
     */
    WrappedKeyJson setKeyId(String keyId) {
        this.keyId = keyId;
        return this;
    }
     ...
     * @return this
     */
    WrappedKeyJson setEncryptedKey(byte[] encryptedKey) {
        this.encryptedKey = encryptedKey;
        return this;
    }
     ...
     * @return this
     */
    WrappedKeyJson setAlgorithm(String algorithm) {
        this.algorithm = algorithm;
        return this;
    }
}
