...
package com.azure.storage.blob.specialized.cryptography.encription.data;
...
public final class EncryptionData {
    ...
    /**
     * A {@link WrappedKeyJson} object that stores the wrapping algorithm, key identifier and the encrypted key
     */
    @JsonProperty(value = "WrappedContentKey", required = true)
    private WrappedKeyJson wrappedContentKey;
     ...
     * @param wrappedContentKey The {@link WrappedKeyJson}.
     ...
     */
    EncryptionData(String encryptionMode, WrappedKeyJson wrappedContentKey, EncryptionAgent encryptionAgent,
     ...
     *
     * @return A {@link WrappedKeyJson} object that stores the wrapping algorithm, key identifier and the encrypted
     *         key bytes.
     */
    WrappedKeyJson getWrappedContentKey() {
     ...
     *
     * @param wrappedContentKey A {@link WrappedKeyJson} object that stores the wrapping algorithm, key identifier and the
     *         encrypted key bytes.
     *
     * @return this
     */
    EncryptionData setWrappedContentKey(WrappedKeyJson wrappedContentKey) {
        this.wrappedContentKey = wrappedContentKey;
        return this;
    }
