...
package com.azure.storage.blob.specialized.cryptography.encryptor.v2;

import com.azure.core.util.logging.ClientLogger;
import com.azure.storage.blob.specialized.cryptography.encription.data.EncryptionAgent;
import com.azure.storage.blob.specialized.cryptography.encryptor.EncryptionAlgorithm;
...
import static com.azure.storage.blob.specialized.cryptography.util.CryptographyConstants.AES_GCM_NO_PADDING;
import static com.azure.storage.blob.specialized.cryptography.util.CryptographyConstants.AES_KEY_SIZE_BITS;
import static com.azure.storage.blob.specialized.cryptography.util.CryptographyConstants.EMPTY_BUFFER;
import static com.azure.storage.blob.specialized.cryptography.util.CryptographyConstants.ENCRYPTION_PROTOCOL_V2;
import static com.azure.storage.blob.specialized.cryptography.util.CryptographyConstants.GCM_ENCRYPTION_REGION_LENGTH;
import static com.azure.storage.blob.specialized.cryptography.util.CryptographyConstants.NONCE_LENGTH;
import static com.azure.storage.blob.specialized.cryptography.util.CryptographyConstants.TAG_LENGTH;

public class EncryptorV2 extends Encryptor {
    private static final ClientLogger LOGGER = new ClientLogger(EncryptorV2.class);

    public EncryptorV2(SecretKey aesKey) {
        super(aesKey);
    }
    ...
    @Override
    protected EncryptionData buildEncryptionData(Map<String, String> keyWrappingMetadata, WrappedKeyJson wrappedKey) {
